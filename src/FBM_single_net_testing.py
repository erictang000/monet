...
prediction, NDpred = FBM_net_on_file(file = './data/20191212-20200116-20200313-AuNRs_300.mat',stepsActual=300)
print(prediction.shape)
print(prediction)
# pickle.dump( prediction, open( "./results/predH-20191212-20200313-20200116-AuNRs-trimmed300.p", "wb" ) )
# pickle.dump( NDpred, open( "./results/NDpred-20191212-20200313-20200116-AuNRs-trimmed300.p", "wb" ) )